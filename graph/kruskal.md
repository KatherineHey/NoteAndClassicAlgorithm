...
按照边的权重顺序（从小到大）将边加入生成树中，但是若加入该边会与生成树形成环则不加入该边。直到树中含有V−1{\displaystyle V-1}![V-1](https://wikimedia.org/api/rest_v1/media/math/render/svg/cf99922c8908cda9655d87b4a60c0cf3923e0e12)条边为止。这些边组成的就是该图的最小生成树。

Kruskal算法的时间复杂度为Elog⁡E{\displaystyle E\log E}![{\displaystyle E\log E}](https://wikimedia.org/api/rest_v1/media/math/render/svg/1971d0e6bebcf6b64efc398cef3219c6c8e87ff3)。
